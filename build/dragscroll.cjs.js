...
var DragScroll = /** @class */ (function () {
    ...
    Object.defineProperty(DragScroll.prototype, "MOUSE", {
        get: function () {
            return {
                SCROLL: 1,
                RIGHT: 2,
    ...
    Object.defineProperty(DragScroll.prototype, "MOUSE_EVENT_TYPE", {
        get: function () {
            return {
    ...
    DragScroll.prototype.onDragEnd = function (evt) {
        ...
        if (evt.type === this.MOUSE_EVENT_TYPE.MOUSE_LEAVE)
            return;
